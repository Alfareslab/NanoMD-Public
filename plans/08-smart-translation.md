...
| `[ ]` | `[ ]` | اختبار الترجمة AR→EN مع نص عربي (أقواس، bold، أكواد) |
| `[ ]` | `[ ]` | اختبار ترجمة النص المحدد (selected text) فقط |
| `[ ]` | `[ ]` | اختبار حد الـ 5000 حرف + رسالة الخطأ |
| `[ ]` | `[ ]` | اختبار زر التراجع (Undo) بعد الترجمة |
| `[ ]` | `[ ]` | اختبار مع الثيمات الثلاثة |
| `[ ]` | `[ ]` | تحديث `package.json` → v1.4.0 |
| `[ ]` | `[ ]` | تحديث `App.tsx` footer → v1.4.0 |
| `[ ]` | `[ ]` | تحديث `project-context.md` — إضافة ميزة الترجمة |
| `[ ]` | `[ ]` | تحديث `project-key.md` — لو فيه ملفات جديدة |
| `[ ]` | `[ ]` | تحديث `changelog.md` — تسجيل v1.4.0 |
| `[ ]` | `[ ]` | تحديث `docs/presentation-ar.md` — إضافة ميزة الترجمة |
| `[ ]` | `[ ]` | نشر على GitHub + Cloudflare |
